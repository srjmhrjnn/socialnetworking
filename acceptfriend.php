		...
		<div id="wrapper">
			<div class="header">
					...
					<div class="content">
						...
						$usid1 = $rows1['0']['ID'];
						$pic=$_GET['uid'];
						$sql = "SELECT count(*) FROM `friendreq` WHERE `ID1`='$pic' and `ID2`='$usid1'";	
						...
						{
							if($pic<>''){
								$sql = "INSERT INTO friends (ID1,ID2) VALUES ('$pic','$usid1')";
								$conn->exec($sql);
							
							echo '<h3><font color="green">Friend request accepted</font></h3>';
								$sql1 = "DELETE FROM friendreq WHERE ID1='$pic' AND ID2='$usid1'";
								$conn->exec($sql1);
							}
						}
